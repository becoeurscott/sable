  ...
  return (
    <div>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        />
        <div className="r-aside" style={{ maxWidth: 1200, margin: "0 auto", padding: "76px 28px 40px", position: "relative", display: "grid", gridTemplateColumns: "1.05fr .95fr", gap: 52, alignItems: "center" }}>
          <div style={{ animation: "sbFadeUp .7s ease both" }}>
            ...
            <h1 className="sb-h1" style={{ fontFamily: DISPLAY, fontSize: 59, lineHeight: 1.02, letterSpacing: "-.03em", fontWeight: 700, margin: "0 0 20px" }}>
              Your AI CFO,
              <br />
              working{" "}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 20, fontSize: 13.5, color: "#71798A", fontWeight: 500, flexWrap: "wrap" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 28px 20px" }}>
        <Reveal>
          <div style={{ maxWidth: 640, marginBottom: 44 }}>
            ...
            <h2 className="sb-h2" style={{ fontFamily: DISPLAY, fontSize: 38, lineHeight: 1.08, letterSpacing: "-.025em", fontWeight: 700, margin: "0 0 14px" }}>
        ...
        <div className="r-3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 18 }}>
          {features.map((f, i) => (
            <Reveal key={f.title} delay={(i % 3) * 90}>
              <div className="sb-card" style={{ background: "#F7F9FC", border: "1px solid #EBEFF6", borderRadius: 18, padding: 26, height: "100%" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", maxWidth: 560, margin: "0 auto 50px" }}>
              ...
              <h2 className="sb-h2" style={{ fontFamily: DISPLAY, fontSize: 38, lineHeight: 1.08, letterSpacing: "-.025em", fontWeight: 700, margin: 0, color: "#F3F6FC" }}>
                From messy bank feed to clear answers in 5 minutes.
              </h2>
            </div>
          </Reveal>
          <div className="r-3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
            {steps.map((st, i) => (
              <Reveal key={st.n} delay={i * 100}>
                <div className="sb-card" style={{ background: "#0F1830", border: "1px solid #1D2A47", borderRadius: 18, padding: 28, height: "100%" }}>
      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "80px 28px 20px" }}>
        <Reveal>
          <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto 40px" }}>
            <h2 className="sb-h2" style={{ fontFamily: DISPLAY, fontSize: 36, lineHeight: 1.1, letterSpacing: "-.025em", fontWeight: 700, margin: "0 0 12px" }}>Why teams switch to Sable</h2>
        ...
        <div className="sb-xscroll-inner" style={{ border: "1px solid #E7ECF4", borderRadius: 18, overflow: "hidden", boxShadow: "0 20px 44px -26px rgba(11,16,32,.18)" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "70px 28px" }}>
        <div className="r-4" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 20, textAlign: "center" }}>
          {stats.map((m, i) => (
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "20px 28px 70px" }}>
        <Reveal>
        <div className="sb-card" style={{ background: "#F7F9FC", border: "1px solid #EBEFF6", borderRadius: 22, padding: 44 }}>
      ...
      <div style={{ background: "#0A1020", padding: "80px 28px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center", position: "relative" }}>
          <h2 className="sb-h2" style={{ fontFamily: DISPLAY, fontSize: 44, lineHeight: 1.06, letterSpacing: "-.03em", fontWeight: 700, color: "#F3F6FC", margin: "0 0 16px" }}>Meet your AI CFO today.</h2>
