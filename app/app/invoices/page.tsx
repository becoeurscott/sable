...
export default function Invoices() {
  ...
  return (
    <div style={{ maxWidth: 1000, animation: "sbFadeUp .4s ease both" }}>
      <div className="r-4" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14, marginBottom: 18 }}>
        {invStats.map((k) => (
      ...
      <div style={{ background: "#fff", border: "1px solid #EAEEF5", borderRadius: 16, overflow: "hidden" }}>
        ...
        {showInvoiceForm && (
          <div style={{ padding: "20px 22px", background: "#F7F9FC", borderBottom: "1px solid #EEF1F7", animation: "sbFadeUp .3s ease both" }}>
            <div className="r-form" style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr", gap: 12, marginBottom: 14 }}>
              <div>
        ...
        <div className="sb-xscroll">
          <div className="sb-xscroll-inner">
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr 1fr 1fr", padding: "12px 22px", fontSize: 12, color: "#8A93A3", fontWeight: 600, borderBottom: "1px solid #EEF1F7", background: "#FBFCFE" }}>
              <div>Invoice</div>
              <div>Client</div>
              <div>Due</div>
            ...
            {invoices.map((r, i) => {
              ...
              return (
                <div key={r.id + i} style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr 1fr 1fr", alignItems: "center", padding: "14px 22px", borderBottom: "1px solid #F1F4F9" }}>
