...
export const appNav: NavItem[] = [
  ...
  { label: "Revenue", icon: "⊞", href: "/app/revenue" },
  { label: "Reports", icon: "◱", href: "/app/reports" },
  { label: "Billing", icon: "◎", href: "/app/billing" },
  { label: "Settings", icon: "⚙", href: "/app/settings" },
];
...
export const appMeta: Record<string, { title: string; sub: string }> = {
  ...
  revenue: { title: "Revenue", sub: "Track income by source" },
  reports: { title: "Reports", sub: "P&L, cash flow and runway" },
  billing: { title: "Billing & plan", sub: "Manage your subscription and usage" },
  settings: { title: "Settings", sub: "Organization, team and security" },
  search: { title: "Search", sub: "Ask your finances anything, in plain English" },
};
